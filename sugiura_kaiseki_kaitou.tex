...
\begin{leftbar}
    求める面積を $S$とすると，第1象限と第4象限の面積を$2$倍すればよいので，
    \begin{align*} 
        S & =2 \cdot  \frac{1}{2}\int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} r^2 \, d \theta \\
        & =  \int_{-\frac{\pi}{4}}^{\frac{\pi}{4}} (2a^2 \cos 2\theta) \, d \theta \\
        & =\Bigl [ a^2 \sin 2\theta \Bigl ]_{-\frac{\pi}{4}}^{\frac{\pi}{4}} \\
        & = \left ( a^2 \sin (\pi/2)-a^2 \sin (-\pi/2) \right) \\
        & = 2a^2
    \end{align*} 
    となる．
\end{leftbar}
