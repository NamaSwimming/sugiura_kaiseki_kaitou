...
\newpage 
\subsection*{p42-43：3)}
\addcontentsline{toc}{subsection}{\texorpdfstring{p42-43：3)}{p42-43：3)}}
...
\subsection*{4)-(ii)}
  ...
  \end{leftbar}
    ...
    \subsection*{p72-74：3}
\addcontentsline{toc}{subsection}{\texorpdfstring{p72-74：3}{p72-74：3}}
...
\addcontentsline{toc}{subsection}{\texorpdfstring{p106-107：3}{p106-107：3}}
...
\subsection*{p126：2}
\addcontentsline{toc}{subsection}{\texorpdfstring{p126：2}{p126：2}}
...
\addcontentsline{toc}{subsection}{\texorpdfstring{p211-212：1}{p211-212：1}}
...
\begin{tleftbar}
    ...
    \addcontentsline{toc}{subsection}{\texorpdfstring{p211-212：2}{p211-212：2}}
...
\[
\frac{\partial}{\partial t} \left( -\frac{1}{t+\cos x} \right) = \frac{1}{(t+\cos x)^2} 
\]
で
\[
\int_0^\pi \left ( -\frac{1}{t+\cos x} \right) \, dx , \quad \frac{1}{(t+\cos x)^2} 
\]
は$t>1$で連続で，
\begin{alignat*}{2}
    F(t) & = \int_0^\pi \frac{\partial}{\partial t} \left ( - \frac{1}{t+\cos x} \right) \, dx  & &\\
    & = \frac{d}{d t} \int_0^\pi \left( -  \frac{dx}{t+\cos x} \right) & \quad & \text{($\because$~定理14.1)}\\
    & = \frac{d}{d t} \int_0^\infty \left (-\frac{1}{t+ \frac{1-s^2}{1+s^2}} \right)  \frac{2ds}{1+s^2} & & \\
    & = -\frac{d}{d t} \int_0^\infty \frac{2ds}{ (1+s^2)t + 1-s^2} & & \\
    & = -2 \frac{d}{d t} \int_0^\infty \frac{ds}{(t-1)s^2+t+1} & & \\
    & = -2 \frac{d}{dt} \Bigl [ \frac{1}{\sqrt{t+1}} \arctan \sqrt{\frac{t-1}{t+1}} s \Bigr ]_{s=0}^{s=\infty} & & \\
    & = -2 \frac{d }{d t} \left ( \frac{1}{\sqrt{t^2-1}}\frac{\pi}{2}  \right ) & & \\
    & = \pi  \frac{d}{dt} \{ -(t^2-1)^{-1/2} \}  & & \\
    & = \pi \left ( - \frac{1}{2} \right )\{ -(t^2-1)^{-3/2} \} 2t & & \\
    & = \frac{\pi t}{(t^2-1)^{3/2}}. & &
\end{alignat*}
\end{tleftbar}
