...
\addcontentsline{toc}{subsection}{\texorpdfstring{p42-43：11)}{p42-43：11)}}
...
\subsection*{4)-(ii)}
  ...
  \end{leftbar}
    ...
    \newpage 
    \subsection*{p63-64：5}
    \addcontentsline{toc}{subsection}{\texorpdfstring{p63-64：5}{p63-64：5}}
    \begin{leftbar}
      \begin{proof} \mbox{　}  
        \begin{enumerate}[(I)]
        \item \mbox{} \\
    ...
    \subsection*{p63-64：6}
    \addcontentsline{toc}{subsection}{\texorpdfstring{p63-64：6}{p63-64：6}}
    ...
    \subsection*{p63-64：7}
    \addcontentsline{toc}{subsection}{\texorpdfstring{p63-64：7}{p63-64：7}}
    \begin{leftbar}
    ...
    \subsection*{p63-64：8}
    \addcontentsline{toc}{subsection}{\texorpdfstring{p63-64：8}{p63-64：8}}
    \begin{leftbar}
      $ [0,1]$に対し，
      \[
      f(x)= \begin{cases} 
    ...
    \subsection*{p63-64：9}
    \addcontentsline{toc}{subsection}{\texorpdfstring{p63-64：9}{p63-64：9}}

    \begin{leftbar}
    \begin{proof}[\textup{\textbf{証明1}}]
