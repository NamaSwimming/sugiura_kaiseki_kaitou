...
\problem[subproblems = 5]{p16--17}{1}
...
\problem[label=problem:p16--17:3]{p16--17}{3}
...
\problem[subproblems = 7]{p31--33}{1}
...
\problemtodo{p31--33}{3}
\problemtodo{p31--33}{4}
\problemtodo{p31--33}{5}
\problemtodo{p31--33}{6}
\problemtodo{p31--33}{7}
\problemtodo{p31--33}{8}
\problemtodo{p31--33}{9}
\problemtodo{p31--33}{10}
...
\problemtodo{p42--43}{1}
\problemtodo{p42--43}{2}
...
\problemtodo{p42--43}{4}
\problemtodo{p42--43}{5}
\problemtodo{p42--43}{6}
\problemtodo{p42--43}{7}
\problemtodo{p42--43}{8}
\problemtodo{p42--43}{9}
\problemtodo{p42--43}{10}
...
\problem[subproblems = 11]{p49--50}{2}
...
\subproblem[label=p49--50：2-(x)]{10}
...
\problem[subproblems = 2]{p49--50}{7}
\subproblem{1}
...
\problem[subproblems = 5]{p63--64}{1}
...
\problem[subproblems = 5]{p63--64}{2}
...
\problem[subproblems = 2]{p63--64}{3}
...
\problem[subproblems = 2]{p63--64}{4}
...
\problem[label = p63--64：6]{p63--64}{6}
\begin{tproof}
    \begin{enumerate}[(I)]
        \item \mbox{} \\
...
\problemtodo{p63--64}{10}

\problem[subproblems = 5]{p72--74}{1}
...
\problemtodo[subproblems = 3]{p72--74}{2}
...
\problem[label = p79--80：3]{p79--80}{3}
\begin{tproof}
...
\problem[label = p79--80：4]{p79--80}{4}
\begin{tproof}
...
\problem[label = p79--80：5]{p79--80}{5}
\begin{tproof}
...
\problem[label = p79--80：7]{p79--80}{7}
\begin{tproof}
...
\problem[label = p79--80：10]{p79--80}{10}
\begin{tproof}
...
\problem[label = p79--80：11]{p79--80}{11}
\begin{tproof}
...
% subproblem 1 と 2 は省略しているので，subproblems の個数は 2 としておく
\problem[subproblems = 2, label = p79--80：12]{p79--80}{12}

(\romannumeral1)，(\romannumeral2)は(\romannumeral3)より略す．


\subproblem[label = p79--80：12-(\romannumeral3)]{3}
...
\subproblem[label = p79--80：12-(\romannumeral4)]{4}
...
\problem[label = p79--80：13]{p79--80}{13}
\begin{tproof}
