...
\newmdenv[
  ...
  bottomline=false,
  rightline=false,
  skipabove=\smallskipamount,   % ★変更：環境上のスペースを詰めて、改ページを抑制
  skipbelow=\smallskipamount,   % ★変更：環境下のスペースも同様に
  leftmargin=10pt,
  rightmargin=0pt,
...
\newenvironment{tproof}[1][証明]{%
  \begin{leftbarstyle}
    % \hspace と \strut を削除し、\kakko と同じ見た目に
    {\setlength{\fboxsep}{3.5pt}\noindent\colorbox{gray!25}{\sffamily\bfseries #1}\par}\medskip
    }{%
    \par\nopagebreak\hfill\qed
  \end{leftbarstyle}
}
